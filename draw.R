...
ggsave("16SB_General_Recall.png", width=6, height=6)
...
ggsave("Hackett_General_Recall.png", width=6, height=6)
...
ggsave("small10aa_General_Recall.png", width=6, height=6)
...
ggsave("16SB_ErrLen_ROC.png", width=6, height=6)
...
ggplot(data=A, aes(x, y, color=as.factor(DR))) + geom_point(alpha=1)+
  ...
  ggtitle("16S.B: ROC")
ggsave("16SB_General_ROC.png", width=6, height=6)
...
ggplot(data=A, aes(x, y, color=as.factor(DR))) + geom_point(alpha=1)+
  ...
  scale_y_continuous("Recall",labels=percent,breaks = c(0.2,0.4,0.6,0.8,0.9,0.95,1,1.1))+
  ggtitle("Hackett: ROC")
ggsave("Hackett_General_ROC.png", width=6, height=6)
...
ggsave("small10aa_General_ROC.png", width=6, height=6)
